...
namespace hwa_gnss
{
    ...
    double gnss_model_gpt::a_geoid[55] = {
    ...
    double gnss_model_gpt::b_geoid[55] = {
    ...
    double gnss_model_gpt::ap_mean[55] = {
    ...
    double gnss_model_gpt::bp_mean[55] = {
    ...
    double gnss_model_gpt::ap_amp[55] = {
    ...
    double gnss_model_gpt::bp_amp[55] = {
    ...
    double gnss_model_gpt::at_mean[55] = {
    ...
    double gnss_model_gpt::bt_mean[55] = {
    ...
    double gnss_model_gpt::at_amp[55] = {
    ...
    double gnss_model_gpt::bt_amp[55] = {
    ...
    int gnss_model_gpt::gpt_v1(double dmjd, double dlat, double dlon, double dhgt,
                      double &pres, double &temp, double &undu)
    {
        ...
        double temp0 = atm + ata * cos(doy / 365.25 * 2.0 * hwa_pi);
        ...
        double pres0 = apm + apa * cos(doy / 365.25 * 2.0 * hwa_pi);
