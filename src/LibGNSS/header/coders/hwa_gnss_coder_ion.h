#ifndef hwa_gnss_coder_ion_H
#define hwa_gnss_coder_ion_H
...
namespace hwa_gnss
{
    ...
    */
    class gnss_coder_ion : public gnss_base_coder
    {
    public:
        /**
        * @brief constructor.
        ...
        */
        gnss_coder_ion(set_base *s, std::string version = "", int sz = DEFAULT_BUFFER_SIZE);

        /** @brief default destructor. */
        virtual ~gnss_coder_ion();
