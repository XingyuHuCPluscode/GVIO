...
// A std::set of classes to simulate exceptions in C++
//
...
#define CatchAndThrow \
    ...
    {
    protected:
        static bool do_not_link; // std::set when new is called
...
public:                                   \
    ...
    {                                     \
        ...
        FreeCheck::Register(t, #Class);   \
        return t;                         \
    }                                     \
    void operator delete(void *t)         \
    {                                     \
        FreeCheck::DeRegister(t, #Class); \
        ::operator delete(t);             \
    }
