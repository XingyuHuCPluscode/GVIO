...
//*********************** end of options std::set by user ********************
...
//   extern "C"
//   {
//      int __cdecl std::setjmp(jmp_buf);
...
#ifdef USING_FLOAT // std::set precision type to float
    typedef float Real;
    typedef double long_Real;
#endif

#ifdef USING_DOUBLE // std::set precision type to double
    typedef double Real;
