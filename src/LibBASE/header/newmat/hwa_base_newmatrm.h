...
namespace NEWMAT
{
    ...
    inline RectMatrixRow::RectMatrixRow(const Matrix &M, int row, int skip, int length)
    ...
    inline RectMatrixCol::RectMatrixCol(const Matrix &M, int skip, int col, int length)
