...
#define REPORT                                   \
    {                                            \
        static ExeCounter ExeCount(__LINE__, 8); \
        ++ExeCount;                              \
    }
#else
#define REPORT \
    ...
    // matrices.
    {
      ...
      if (mu1 != mu) std::cout << k << " " << mu << " " << mu1 << std::endl;
      */
                ...
                if (diag != 0)
                {
                    ...
                    sing = true;
                if (++k == nrows_val)
                    break; // so next line won't overflow
                akk += nrows_val + 1;
            }
    }
    ...
    void CroutMatrix::lubksb(Real *B, int mini)
    {
        ...
        // I follow the NR code in skipping over initial zeros in the B std::vector.
    ...
    Real GeneralMatrix::maximum_absolute_value2(int &i, int &j) const
    {
        ...
        {
            int c;
            maxval = mr.MaximumAbsoluteValue1(maxval, c);
            if (c > 0)
            {
                i = r;
                j = c;
    ...
    Real GeneralMatrix::minimum_absolute_value2(int &i, int &j) const
    {
        ...
        if (storage == 0)
            NullMatrixError(this);
        Real minval = FloatingPointPrecision::Maximum();
        int nr = Nrows();
        MatrixRow mr((GeneralMatrix *)this, LoadOnEntry + DirectPart);
        for (int r = 1; r <= nr; r++)
        {
            int c;
            minval = mr.MinimumAbsoluteValue1(minval, c);
            if (c > 0)
            {
                i = r;
                j = c;
    ...
    Real GeneralMatrix::maximum2(int &i, int &j) const
    {
        ...
        if (storage == 0)
            NullMatrixError(this);
        Real maxval = -FloatingPointPrecision::Maximum();
        int nr = Nrows();
        MatrixRow mr((GeneralMatrix *)this, LoadOnEntry + DirectPart);
        for (int r = 1; r <= nr; r++)
        {
            int c;
            maxval = mr.Maximum1(maxval, c);
            if (c > 0)
            {
                i = r;
                j = c;
    ...
    Real Matrix::maximum_absolute_value2(int &i, int &j) const
    {
        REPORT
        int k;
        Real m = GeneralMatrix::maximum_absolute_value1(k);
        k--;
        i = k / Ncols();
        j = k - i * Ncols();
        i++;
    ...
    Real Matrix::minimum_absolute_value2(int &i, int &j) const
    {
        REPORT
        int k;
        Real m = GeneralMatrix::minimum_absolute_value1(k);
        k--;
        i = k / Ncols();
        j = k - i * Ncols();
        i++;
    ...
    Real Matrix::maximum2(int &i, int &j) const
    {
        REPORT
        int k;
        Real m = GeneralMatrix::maximum1(k);
        k--;
        i = k / Ncols();
        j = k - i * Ncols();
        i++;
    ...
    Real Matrix::minimum2(int &i, int &j) const
    {
        REPORT
        int k;
        Real m = GeneralMatrix::minimum1(k);
        k--;
        i = k / Ncols();
        j = k - i * Ncols();
        i++;
    ...
    {
        REPORT return fabs(trace());
    } // no need to do tDelete?
    ...
    {
        REPORT GeneralMatrix *gm = ((BaseMatrix &)*this).Evaluate();
        Real s = gm->maximum_absolute_value();
        return s;
    }
    ...
    {
        REPORT GeneralMatrix *gm = ((BaseMatrix &)*this).Evaluate();
        Real s = gm->maximum_absolute_value1(i);
        return s;
    }
    ...
    {
        REPORT GeneralMatrix *gm = ((BaseMatrix &)*this).Evaluate();
        Real s = gm->maximum_absolute_value2(i, j);
        return s;
    }
    ...
    {
        REPORT GeneralMatrix *gm = ((BaseMatrix &)*this).Evaluate();
        Real s = gm->minimum_absolute_value();
        return s;
    }
    ...
    {
        REPORT GeneralMatrix *gm = ((BaseMatrix &)*this).Evaluate();
        Real s = gm->minimum_absolute_value1(i);
        return s;
    }
    ...
    {
        REPORT GeneralMatrix *gm = ((BaseMatrix &)*this).Evaluate();
        Real s = gm->minimum_absolute_value2(i, j);
        return s;
    }
    ...
    {
        REPORT GeneralMatrix *gm = ((BaseMatrix &)*this).Evaluate();
        LogAndSign sum = gm->log_determinant();
        return sum;
    }
    ...
    LinearEBASE_QUATionSolver::LinearEBASE_QUATionSolver(const BaseMatrix &bm)
    {
