...
#include "HWA_BASE_NEWMAT_Include.h" // include standard files
...
namespace NEWMAT
{
    ...
    // write matrix details to Exception buffer
    {
        ...
        int ubw = bw.upper_val;
        int lbw = bw.lower_val;
        BaseException::AddMessage("MatrixType = ");
        BaseException::AddMessage(A.Type().Value());
        BaseException::AddMessage("  # Rows = ");
        BaseException::AddInt(A.Nrows());
        BaseException::AddMessage("; # Cols = ");
        BaseException::AddInt(A.Ncols());
        if (lbw >= 0)
        {
    ...
    {
        Select = BaseException::Select;
        AddMessage("detected by Newmat: cannot convert matrix to std::vector\n\n");
        Tracer::AddTrace();
    }
    ...
    IncompatibleDimensionsException::IncompatibleDimensionsException(const GeneralMatrix &A, const GeneralMatrix &B)
        : Logic_error()
    {
        Select = BaseException::Select;
        AddMessage("detected by Newmat: incompatible dimensions\n\n");
...
NPDException::NPDException(const GeneralMatrix &A) : Runtime_error()
{
}

SingularException::SingularException(const GeneralMatrix &A) : Runtime_error() {}

ConvergenceException::ConvergenceException(const GeneralMatrix &A) : Runtime_error() {}
...
ProgramException::ProgramException(const char *c, const GeneralMatrix &A) : Logic_error() {}

ProgramException::ProgramException(const char *c, const GeneralMatrix &A, const GeneralMatrix &B) : Logic_error() {}

ProgramException::ProgramException(const char *c, MatrixType a, MatrixType b) : Logic_error() {}

VectorException::VectorException() : Logic_error() {}

VectorException::VectorException(const GeneralMatrix &A) : Logic_error() {}

NotSquareException::NotSquareException(const GeneralMatrix &A) : Logic_error() {}

NotSquareException::NotSquareException() : Logic_error() {}

SubMatrixDimensionException::SubMatrixDimensionException() : Logic_error() {}

IncompatibleDimensionsException::IncompatibleDimensionsException() : Logic_error() {}

IncompatibleDimensionsException::IncompatibleDimensionsException(const GeneralMatrix &A, const GeneralMatrix &B) : Logic_error() {}

IncompatibleDimensionsException::IncompatibleDimensionsException(const GeneralMatrix &A) : Logic_error() {}

NotDefinedException::NotDefinedException(const char *op, const char *matrix) : Logic_error() {}

CannotBuildException::CannotBuildException(const char *matrix) : Logic_error() {}

IndexException::IndexException(int i, const GeneralMatrix &A) : Logic_error() {}

IndexException::IndexException(int i, int j, const GeneralMatrix &A) : Logic_error() {}

IndexException::IndexException(int i, const GeneralMatrix &A, bool) : Logic_error() {}

IndexException::IndexException(int i, int j, const GeneralMatrix &A, bool) : Logic_error() {}
...
InternalException::InternalException(const char *c) : Logic_error() {}
    ...
    int ExeCounter::nreports; // will be std::set to zero
